"""Add original_text and question_type to questions

Revision ID: d6a31dbc299c
Revises: e4f8c9d12345
Create Date: 2025-08-12 12:22:39.243321
...
revision: str = 'd6a31dbc299c'
down_revision: Union[str, None] = 'e4f8c9d12345'
...
def upgrade() -> None:
    ...
    op.add_column('questions', sa.Column('original_text', sa.Text(), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('questions', 'original_text')
